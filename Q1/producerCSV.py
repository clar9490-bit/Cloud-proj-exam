...
try: 
    testFile = open("cred.json")
    print(" cred file exists")
except IOError:
    print("Files are not accessible")
finally: 
    testFile.close()
...
try: 
    testFile = open("time-series-19-covid-combined.csv")
    print(" cvs file exists")
except IOError:
    print("Files are not accessible")
finally: 
...
#Taken from Confluent Cloud
topicName='Exam'                        #TODO: fill by topic name
schemaID= 'LJQC3YETIGNF77NZ';                         #TODO: set the schema ID.
